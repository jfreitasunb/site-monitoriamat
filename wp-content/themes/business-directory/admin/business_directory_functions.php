...
/* Add Favicon
  /*----------------------------------------------------------------------------------- */
function business_directory_childtheme_favicon() {
    if (business_directory_get_option('business_directory_favicon') != '') {
        echo '<link rel="shortcut icon" href="' . esc_url(business_directory_get_option('business_directory_favicon')) . '"/>' . "\n";
    }
}

add_action('wp_head', 'business_directory_childtheme_favicon');
/* ----------------------------------------------------------------------------------- */
/* Custom CSS Styles */
/* ----------------------------------------------------------------------------------- */
